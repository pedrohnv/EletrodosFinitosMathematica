...
(*\[CapitalUAcute]ltima altera\[CCedilla]\[ATilde]o: 28 de Novembro de 2017*)
...
Block[{Ls,k1,k2},
	...
	k1 = eletrodo[[3]]/Ls;
	k2 = Sqrt[1. + k1^2.];
	Return[(I \[Omega] \[Mu])/(2. \[Pi]) (Log [(k2 + 1.)/k1] - k2 + k1) + eletrodo[[4]]]
]
...
Block[{ds,dr,Ls,Lr,cos\[Phi],int},
	...
	Return[(I \[Omega] \[Mu] cos\[Phi])/(4. \[Pi] Ls) int]
]
